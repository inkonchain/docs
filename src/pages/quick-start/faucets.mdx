...
Get fake Ether (ETH) from these faucets so you can fund your wallet to send transactions and deploy contracts on Ink Sepolia. You can also [bridge](/quick-start/faucets#bridging-funds-to-ink-sepolia) testnet funds to Ink.
...
* [https://mystery-faucet.demo.inkonchain.com/](https://mystery-faucet.demo.inkonchain.com/)
...
1. Get ETH by using your wallet with one of the existing faucets on the Ethereum Sepolia network:
...
- This is the [`L1StandardBridge Contract`](https://sepolia.etherscan.io/address/0x33f60714bbd74d62b66d79213c348614de51901c).
