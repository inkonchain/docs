...
1. An IDE (integrated developer environment) like [Visual Studio Code](https://code.visualstudio.com/) or [Remix](https://remix.ethereum.org/) to write smart contracts in solidity.
1. A wallet that holds ETH such as [Kraken Wallet](https://www.kraken.com/wallet).
...
Next: get some [play money](https://docs.inkonchain.com/quick-start/faucets) from our faucets!
