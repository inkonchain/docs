...
###### Adding Ink Sepolia to Kraken Wallet
    1. Download Kraken Wallet on your phone if you haven't yet.
    2.
...
- Kraken: https://faucet.ink.kraken.zone/. Our in house faucet provides a quick and easy way to acquire testnet ETH.
- Quicknode: https://quicknode.com. Quicknode faucet is an easy to use Multi-Chain Faucet. You can use Quicknode Faucet to claim Ink Sepolia for testnet ETH for free - one drip per network every 12 hours.
- Tenderly 
- Optimism
- Superchain
