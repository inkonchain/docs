...
1. An editor (with a Solidity highlighting package) like [Visual Studio Code](https://code.visualstudio.com/) to efficiently write smart contract code
...
3. Testnet funds to fund your transactions (see [Faucets](/quick-start/faucets))
...
## What Next? 
Check out the [tutorials](/build/tutorials) to learn how to deploy contracts and more!
