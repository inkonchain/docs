...
growthepie is the open analytics platform for the Ethereum ecosystem. From Ethereum Mainnet to Layer 2s and onchain applications. Showcasing the growth of the ecosystem while also empowering builders with open and actionable metrics on usage and adoption.

**Supported Networks**

* [Ink Mainnet](https://www.growthepie.com/chains/ink)
