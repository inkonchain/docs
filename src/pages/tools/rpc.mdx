...
Grove provides unstoppable, decentralized RPC access on [Pocket Network](https://pocket.network/). 
...
<Callout type="info">
  Looking for infinite scale on a truly decentralized network?
  [Grove](https://grove.city/) provides access to Ink and 50+ other blockchain networks.
</Callout>
...
Grove provides both public and private RPC access to Ink.

#### Ink Mainnet

- HTTPS: <CopyableCode code="https://ink.rpc.grove.city/v1/01fdb492" />
