...
## [NodeFlare](https://nodeflare.app/chains/ink)

NodeFlare serves Ink from its own multi-region bare-metal nodes with automatic failover — a free public endpoint (no API key) plus a free keyed tier with higher limits, `eth_getLogs` and debug/trace support.
...
NodeFlare provides a free public Ink endpoint from dedicated multi-region infrastructure — no API key required.

#### Ink Mainnet

- HTTPS: <CopyableCode code="https://rpc.nodeflare.app/ink/public" />
