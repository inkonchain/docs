...
GetBlock is an RPC node provider and infrastructure platform for Web3 and AI with 130+ blockchain networks supported.
...
<Callout type="info">
  Searching for essential performance and infrastructure features?
  [GetBlock](https://getblock.io/nodes/ink/) provides managed Ink RPC nodes, delivering reliable API endpoints for Ink mainnet without requiring personal infrastructure management or maintenance.
</Callout>
